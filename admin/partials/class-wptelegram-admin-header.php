...
class WPTelegram_Admin_Header {
	...
	public function render_social() {
        // XTEC ************ AFEGIT - Hidden socials to all users but xtecadmin
        // 2020.03.20 @nacho
            ...
            <div class="wptelegram-socials">
                ...
                <div class="wptelegram-social-bttns">
                    <ul style="list-style-type: none">
                        <li>
                            <div class="fb-like" data-href="https://www.facebook.com/WPTelegram"
                                 data-layout="button_count" data-action="like" data-size="small" data-show-faces="false"
                                 data-share="false"></div>
                        </li>
                        <li>
                            <a href="https://twitter.com/WPTelegram" class="twitter-follow-button"
                               data-show-count="false"><?php printf(__('Follow %s', $this->plugin->get_text_domain()), '@WPTelegram'); ?></a>
                        </li>
                        <li>
                            <a href="https://t.me/WPTelegram" class="telegram-follow-button btn" target="_blank">
                                <img src="<?php echo esc_url($this->plugin->get_url() . '/admin/icons/tg-icon.svg'); ?>"
                                     alt="<?php echo $this->plugin->get_plugin_title(); ?>"/>&nbsp;<?php printf(__('Join %s', $this->plugin->get_text_domain()), '@WPTelegram'); ?>
                            </a>
                        </li>
                    </ul>
                    <div id="fb-root"></div>
